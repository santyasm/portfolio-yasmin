...
export const About = () => {
  return (
    <section className="flex flex-col items-center min-h-screen h-auto py-10 justify-center relative" id="about">
      <AnimatedWords
        title="Sobre Mim"
      ...
      <AnimatedBody
        className="text-whitetext text-md md:text-[22px] leading-10 mt-6 lg:w-[48%] font-inter w-[90%] whitespace-pre-line text-center md:text-start"
